...
parser.add_argument('--use_inner_product', type=bool, default=True, help='decide user inner product or mlp')
parser.add_argument('--user_enhanced', type=int, default=1, help='using the user kg enhanced of the item kg')
